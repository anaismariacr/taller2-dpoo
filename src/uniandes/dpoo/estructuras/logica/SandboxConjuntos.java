...
public class SandboxConjuntos
{
    ...
    {
    	NavigableSet<String> lista = arbolCadenas.descendingSet();
    	arbolCadenas = lista;
    	return new ArrayList<>(arbolCadenas);
    }
    ...
    {
    	NavigableSet<String> nuevoCadenas = new TreeSet<>();
    	
    	for(String i : arbolCadenas) {
    		nuevoCadenas.add(i.toUpperCase());
    	}
    	arbolCadenas = nuevoCadenas;
    }
