...
public class SandboxMapas
{
    ...
    public Collection<String> getLlaves( )
    {
        ...
        Collection<String> llavesMayusculas = llaves.stream().map(String::toUpperCase).collect(Collectors.toSet());
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
    	...
    	for(Object i : objetos) {
    		...
    		String llave = new StringBuilder(str).reverse().toString();
    		mapaCadenas.put(llave, str);
    	}	
    }
